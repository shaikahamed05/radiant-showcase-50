...
const SUBTABS: Record<string, { label: string; to: string; params?: Record<string, string>; search?: Record<string, string>; hash?: string }[]> = {
  ...
  Solutions: [
    ...
    { label: "Claims Automation", to: "/solutions/$slug", params: { slug: "claims-automation" } },
    { label: "Renewal Intelligence", to: "/solutions/$slug", params: { slug: "renewal-intelligence" } },
    { label: "Fleet Management", to: "/solutions/$slug", params: { slug: "fleet-management" } },
    { label: "Vendor Management", to: "/solutions/$slug", params: { slug: "vendor-management" } },
