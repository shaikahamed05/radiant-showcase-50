...
export const INDUSTRIES = [
  {
    ...
    priorities: [
      { title: "Accelerate Underwriting", desc: "Improve submissions, reviews, collaboration, approvals, and decision visibility." },
      { title: "Modernize Claims", desc: "Coordinate intake, documents, assignments, exceptions, communications, and outcomes." },
      { title: "Improve Policy Administration", desc: "Streamline servicing, endorsements, renewals, comparisons, and lifecycle activity." },
      { title: "Strengthen Compliance", desc: "Improve document validation, governance, auditability, and exception management." },
    ...
    howWeHelp: [
      ...
      { title: "Business Operations", desc: "Extend delivery capacity where specialized operational support is relevant." }
    ],
    solutions: [
  ...
  },
  {
    ...
    priorities: [
      { title: "Modernize Onboarding", desc: "Coordinate data, documents, approvals, due diligence, and customer communications." },
      { title: "Improve Lending Operations", desc: "Streamline reviews, exceptions, tasks, decisions, and case visibility." },
      { title: "Strengthen Compliance and Risk", desc: "Create governed processes for reviews, investigations, evidence, and audit readiness." },
      { title: "Improve Service Operations", desc: "Route requests and cases to the right team with clear SLAs and status." },
  ...
  },
  {
    ...
    priorities: [
      { title: "Improve Regulatory Operations", desc: "Coordinate documents, reviews, approvals, evidence, and change control." },
      { title: "Strengthen Quality and Compliance", desc: "Create traceable workflows for issues, CAPA-style actions, policies, and audits." },
      { title: "Streamline Document-Intensive Work", desc: "Extract, validate, route, and review regulated content." },
      { title: "Modernize Enterprise Applications", desc: "Build connected experiences for employees, partners, and operational teams." },
  ...
  },
  {
    ...
    priorities: [
      { title: "Improve Supplier Collaboration", desc: "Standardize onboarding, documents, approvals, compliance, and performance." },
      { title: "Modernize Order Operations", desc: "Coordinate requests, approvals, handoffs, status, and exceptions." },
      { title: "Strengthen Quality and Compliance", desc: "Manage inspections, issues, reviews, evidence, and corrective actions." },
      { title: "Improve Service and Fleet Visibility", desc: "Centralize assets, records, documents, requests, and operational status." },
  ...
  },
  {
    ...
    priorities: [
      { title: "Transform Admissions", desc: "Coordinate applications, documents, reviews, decisions, communications, and enrollment." },
      { title: "Improve Student Services", desc: "Centralize requests, cases, routing, SLAs, and status." },
      { title: "Modernize Employee Operations", desc: "Streamline onboarding, leave, approvals, records, and internal services." },
      { title: "Improve Institutional Reporting", desc: "Connect workflows, platforms, and operational data." },
  ...
  },
  {
    ...
    priorities: [
      { title: "Improve Case Management", desc: "Coordinate cases, evidence, tasks, decisions, escalations, and outcomes." },
      { title: "Modernize Citizen Services", desc: "Create accessible intake, self-service, status, and communication experiences." },
      { title: "Strengthen Governance", desc: "Improve traceability, audit readiness, records, and policy-driven execution." },
      { title: "Digitize Administrative Work", desc: "Replace paper, email, and spreadsheets with structured workflows." },
