  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Tech Tammina — We Build Intelligent Operations" },
      {
        ...
        content:
          "Connecting AI, automation, and expertise to drive business impact across insurance, financial services, healthcare, manufacturing, education, and the public sector.",
      },
    ...
    links: [
      ...
      { rel: "icon", href: "https://techtammina.com/wp-content/uploads/2025/05/cropped-Favicon-Tech-Tammina-1-32x32-1.png", type: "image/png" },
