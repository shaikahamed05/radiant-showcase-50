...
export const Route = createFileRoute("/about/partnerships/mendix")({
  component: MendixPage,
  head: () => ({
    meta: [
      { title: "Mendix Practice — Tech Tammina" },
      { name: "description", content: "Explore Tech Tammina Mendix capabilities, solutions, expertise, resources, and managed services." },
    ],
  }),
});
  ...
  return (
    <>
      <PageHero
        ...
        title={<span>Mendix Practice</span>}
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <div>
              ...
              <p className="text-base leading-relaxed text-muted-foreground">
                We utilize the Mendix platform to accelerate application modernization and development timelines. Our certified team builds secure, scalable, and highly interactive applications designed to integrate seamlessly with your core systems and databases, delivering modern solutions without long dev cycles.
              </p>
            </div>
          ...
          <aside className="space-y-6">
            ...
            <div className="gradient-border rounded-2xl bg-card p-6 shadow-sm">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed mb-5">
                Discuss your Mendix development backlog, application requirements, or migration roadmap.
              </p>
              <Link
                to="/contact"
