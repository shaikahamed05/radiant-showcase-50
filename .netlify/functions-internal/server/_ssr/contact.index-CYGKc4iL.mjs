...
function ContactPage() {
	...
	(0, import_react.useEffect)(() => {
		...
		if (channel === "expert") defaultMessage = "I would like to speak with an expert about a process, application, or operating challenge.";
		else if (channel === "demo") defaultMessage = "I would like to arrange a tailored demo for our team.";
