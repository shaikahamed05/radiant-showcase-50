...
//#region node_modules/.nitro/vite/services/ssr/assets/capabilities._slug-BM-SGc7x.js
var import_jsx_runtime = require_jsx_runtime();
var $$splitComponentImporter$1 = () => import("./capabilities.index-CHlZdEBf.mjs");
var Route$1 = createFileRoute("/capabilities/")({
	...
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Enterprise AI & Intelligent Automation, Digital Engineering, Quality Engineering, Managed Services, and Business Operations."
			},
			{
				property: "og:title",
...
var $$splitComponentImporter = () => import("./capabilities._slug-DUi8irPX.mjs");
