...
import { A as Calendar, P as BookOpen, d as Newspaper, o as Sparkles, w as CirclePlay, y as FileText } from "../_libs/lucide-react.mjs";
import { t as Route } from "./resources-D8ZyH4vl.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/resources-BGHDYagQ.js
...
var RESOURCES = [
	...
	},
	{
		...
		body: "Explore how Appian's AI agents, intelligent document processing, process intelligence, and AI-assisted development are being used in governed enterprise workflows."
	},
	{
		icon: BookOpen,
		tag: "Insight",
		title: "Accelerating Enterprise Application Delivery with Mendix",
		body: "Learn how Mendix helps organizations move from business idea to scalable application faster while balancing architecture, integration, security, and maintainability."
	},
	{
		icon: FileText,
		tag: "Insight",
		title: "Enterprise Document Intelligence",
		body: "Discover how organizations can turn policies, contracts, certificates, submissions, invoices, and other unstructured content into trusted business data."
	},
	{
		icon: Sparkles,
		tag: "Insight",
		title: "Knowing What Changed",
		body: "See how intelligent comparison identifies material changes across policies, proposals, contracts, schedules, requirements, and other complex documents."
	},
	{
		icon: FileText,
		tag: "Insight",
		title: "From AI Experiments to Governed Enterprise Workflows",
		body: "Explore how AI can be combined with workflow, business rules, human review, auditability, and performance measurement to create reliable enterprise use cases."
	},
	{
		icon: FileText,
		tag: "Case Study",
